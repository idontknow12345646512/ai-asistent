...
function detectMode(text, imgMode) {
  ...
  if (['najdi obrázk', 'vyhledej', 'ukaž fotky', 'fotky ', 'fotografie ', 'find image', 'photo of'].some(x=>t.includes(x))) return 'image_search'
  return 'chat'
}
...
const I = {
  ...
  thumb_up: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14z"/><path d="M7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"/></svg>,
  thumb_dn: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3H10z"/><path d="M17 2h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"/></svg>,
...
export { themes, I, uid, fmtTime, fmtDate, getFreshToken, callEdge, detectMode, EMOTION_EMOJI, SYS_DEFAULT, EDGE, ANON }
