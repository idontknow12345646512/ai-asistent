...
export const AI_MODELS=[
  ...
  {id:'gemini-25',     name:'Gemini 2.5 Flash 🔷',      short:'2.5',  desc:'Výkonný, podporuje thinking'},
  {id:'gemma4',        name:'Gemma 4 31B ✦',             short:'G4',   desc:'Nejsilnější open model'},
  {id:'gemini-25-pro', name:'Gemini 2.5 Flash Pro 💎',  short:'Pro',  desc:'Pro náročné úlohy'},
]
