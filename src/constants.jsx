...
// Pollinations.ai modely — ZDARMA, bez API klíče
const IMG_MODELS = [
  { id:'flux',         name:'FLUX ⚡',        desc:'Nejlepší kvalita' },
  { id:'flux-realism', name:'FLUX Realism 📷', desc:'Fotorealistický' },
  { id:'flux-anime',   name:'FLUX Anime 🎌',   desc:'Anime styl' },
  { id:'flux-3d',      name:'FLUX 3D 🎮',      desc:'3D render styl' },
  { id:'turbo',        name:'Turbo 🚀',         desc:'Nejrychlejší' },
]

// AI modely pro chat
const AI_MODELS = [
  { id:'default',     name:'Gemini Auto ✦',  desc:'Automaticky nejlepší dostupný model' },
...
const PERSONAS = [
  ...
  { label:'Expert programátor',     val:'Jsi expert na programování. Odpovídáš přesně s kódovými příklady a preferuješ stručnost.' },
  ...
  { label:'Data analyst 📊',        val:'Jsi analytik dat. Pomáháš interpretovat data, tabulky a grafy. Preferuješ přesnost a čísla.' },
]
...
const THEMES = {
  ...
  light:    {bg:'#f4f6fb',side:'#ffffff',hdr:'rgba(244,246,251,.96)',txt:'#1a1d2a',muted:'#7a849a',border:'#e2e6f0',accent:'#4c6ef5',purple:'#9333ea',green:'#16a34a',active:'#eef1ff',aiB:'#ffffff',inBg:'#ffffff',iaBg:'#f4f6fb',inBrd:'#d8dde8',btn:'#edf0f7',modal:'#ffffff',pill:'#edf0f7',ua:'#8898b0',scrl:'#c8cdd8',card:'#edf0f7',tag:'#eef1ff',success:'rgba(22,163,74,.12)',succ:'#276749',danger:'#dc2626',isDark:false,gradA:'#4c6ef5',gradB:'#9333ea'},
...
export { EDGE, ANON, SYS_DEFAULT, EMOTION_EMOJI, CONV_COLORS, IMG_MODELS, AI_MODELS, PERSONAS, QUIZ_COUNTS, QUIZ_DIFFS, THEMES, THEME_LIST, Ic, uid, fmtTime, fmtDate, getFreshToken, callEdge, detectAutoMode, mkLocal, renderMD }
